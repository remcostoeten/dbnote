  ...
  return (
    <>
      ...
      >
        ...
        <div className="relative mt-16 grid max-w-full gap-4 rounded-md border border-zinc-900 bg-neutral-900 ring-1 ring-white/10 sm:mt-24 sm:grid-cols-2">
        ...
        <div className="hidden h-full flex-col md:flex">
          ...
          <Tabs defaultValue="insert" className="flex-1">
            <div className="container h-full py-6">
              <div className="grid h-full items-stretch gap-6 md:grid-cols-[1fr_200px] w-full">
