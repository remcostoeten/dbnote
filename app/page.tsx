        ...
        <section className="space-y-6 pb-8 pt-6 md:pb-12 md:pt-10 lg:py-32">
          <div className="container flex max-w-[64rem] flex-col items-center gap-4 text-center">
            ...
            <p className="mmax-w-[48rem] w-full leading-normal text-muted-foreground sm:text-xl sm:leading-8">
              I&apos;m a <span className="dutch">dutch</span> front-end
              developer with a graphic design degree. Passionate about building
              beautifull applications. And lately features which help me be more
              productive.
            </p>
            <div
