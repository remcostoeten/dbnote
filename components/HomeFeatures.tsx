...
export const HomeFeatures = () => (
  ...
  >
    <div className="flex items-center flex-col bigContainer space-y-6 pb-2 pt-2 md:pb-12 md:pt-10 lg:py-12  text-center">
      ...
      >
        This project contains a mix off showcasing stuff I build. A lot of
        experiments stuff which I build to learn new things. Besides that some
        productivity tools I build for myself.
      </motion.p>
    </div>
  </motion.section>
)
