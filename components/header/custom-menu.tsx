    ...
    return (
        <NavigationMenu.Root className="relative z-[1] flex w-screen">
            <NavigationMenu.List className="center shadow-blackA7 m-0 flex list-none rounded-[6px]  p-1 shadow-[0_2px_10px]">
                <NavigationMenu.Item>
                    <NavigationMenu.Trigger className="text-violet11 hover:bg-violet3 focus:shadow-violet7 group flex select-none items-center justify-between gap-[2px] rounded-[4px] px-3 py-2 text-[15px] font-medium leading-none outline-none focus:shadow-[0_0_0_2px] bg-black">
                        Learn{' '}
                        <CaretDownIcon
                ...
                <NavigationMenu.Item>
                    ...
                    <NavigationMenu.Content className="absolute text-black top-0 left-0 w-full sm:w-auto">
                        <ul className="m-0 grid list-none bg-black gap-x-[10px] p-[22px] sm:w-[600px] sm:grid-flow-col sm:grid-rows-3">
